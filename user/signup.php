                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="" method="post">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingText" name="uname" placeholder="Enter Uername" required>
                                <label for="floatingText">Username</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingContact" name="mobile" placeholder="Enter Contact" min="0" required>
                            ...
                            <div class="form-floating mb-4">
                                <input type="password" class="form-control" id="floatingPassword" name="pkey" placeholder="Enter Password" required>
                            ...
                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4" name="sup">Sign Up</button>
                        </form>
                        <p class="text-center mb-0">Already have an Account? <a href="signin.php">Sign In</a></p>
                        <?php
                            if(isset($_POST['sup']))
                            {
                                $resp = usersingup($_POST);
                                if($resp == 1)
                                {
                                    echo '<p style="color: green;">Proceed to login</p>';
