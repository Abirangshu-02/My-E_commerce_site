...
?>
                    ...
                    <div class="row g-5">
                        <div class="col-md-12 col-lg-6 col-xl-7">
                            <div class="form-item">
                                ...
                                <input type="text" class="form-control" name="user" id="user" value="<?php echo $dta['uname']?>" readonly>
                            </div>
                            <?php
                                if(empty($dta['address_zip']))
                                {
                                    echo '
                                        <div class="form-item">
                                            <label class="form-label my-3">Shipping Address with Zipcode <sup>*</sup></label>
                                            <input type="text" class="form-control" id="shipaddresss1" name="adress" placeholder="House Number , Street Name , Town(or City) - Zipcode" required>
                                        </div>
                                    ';
                                }
                                else
                                {
                                    echo '
                                        <div class="form-item">
                                            <label class="form-label my-3">Shipping Address with Zipcode <sup>*</sup></label>
                                            <input type="text" class="form-control" id="shipaddresss1" name="adress" value="'.$dta["address"].'" required>
                                        </div>
                                    ';
                                }
                            ?>
                            ...
                            <div class="form-item">
                                ...
                                <input type="tel" class="form-control" name="phone" id="phone" value="<?php echo $dta['contact']?>" readonly>
                            </div>
                            <div class="form-item">
                                <label class="form-label my-3">Email Address<sup>*</sup></label>
                                <input type="email" class="form-control" name="mail" id="mail" value="<?php echo $dta['email']?>" readonly>
                            </div>
                            <hr>
                            <div class="form-item">
                                <textarea name="text" id="notes" class="form-control" spellcheck="false" cols="30" rows="11" placeholder="Orderer Notes (Optional)"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6 col-xl-5">
                                            ...
                                            if($rows > 0)
                                            {
                                                ...
                                                while($data = mysqli_fetch_assoc($resp))
                                                {
                                                    ...
                                                    while($pddata = mysqli_fetch_assoc($response))
                                                    {
                                                        ...
                                                        ';
                                                        // $_SESSION['productids'][] = $pddata['id'];
                                                        // $_SESSION['quantities'][] = $qty;
                                                        $types++;
                                                        $subtotal += $itmprice;
                                                        $all_qty += $qty;
                                                    }
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-5">
                                                <div class="py-3 border-bottom border-top">
                                                    <p class="mb-0 text-dark">Rs. <?php echo $subtotal;?></p>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3" class="py-5">
                                                <?php
                                                    if($subtotal < 500)
                                                    {
                                                        ...
                                                        echo '
                                                            <div class="form-check text-start">
                                                                <input type="radio" class="form-check-input bg-primary border-0" id="Shipping-1" name="Shipping-1" value="Shipping" disabled>
                                                                <label class="form-check-label" for="Shipping-1">Free Shipping</label>
                                                            </div>
                                                            <div class="form-check text-start">
                                                                <input type="radio" class="form-check-input bg-primary border-0" id="Shipping-2" name="Shipping-1" value="Shipping" checked>
                                                                <label class="form-check-label" id="sp" for="Shipping-2">Flat rate: Rs 50.00</label>
                                                            </div>
                                                        ';
                                                    }
                                                    else
                                                    {
                                                        ...
                                                        <div class="form-check text-start">
                                                            <input type="radio" class="form-check-input bg-primary border-0" id="Shipping-2" name="Shipping-1" value="Shipping" disabled>
                                                            <label class="form-check-label" id="sp" for="Shipping-2">Flat rate: Rs 50.00</label>
                                                        </div>
                                                        ';
                                                    }
                                            ...
                                            <td class="py-5">
                                                <div class="py-3 border-bottom border-top">
                                                    <?php
                                                        ...
                                                        {
                                                            $total = $subtotal + 50;
                                                            echo '<p class="mb-0 text-dark" id="ttprice">Rs.'.$total.'</p>';
                                                        }
                                                        else
                                                        {
                                                            $total = $subtotal;
                            ...
                            <div class="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
                                <div class="col-12">
                                    <div class="form-check text-start my-3">
                                        <label class="form-check-label me-3 text-dark" for="paygate">Payment Options: </label>
                                        <select name="paygate" id="paygate" style="border-radius: 10px;" required>
                                            <option style="text-align: center" value="">Select Payment Mode</option>
                                            <option style="text-align: center" value="online">Online</option>
                                            <option style="text-align: center" value="cod">Cash on Delivery</option>
                                        </select>                                            
                                    </div>
                            ...
                            <div class="row g-4 text-center align-items-center justify-content-center pt-4">
                                <button type="submit" class="btn border-secondary py-3 px-4 text-uppercase w-100 text-primary" onclick="placeorder()">Place Order</button>
                            </div>
                        </div>
                    </div>
                <!-- </form> -->
    ...
    <script>
        ...
        {
            var itm = "Item Orders"
            var shipadd = document.getElementById('shipaddresss1').value
            ...
            else
            {
                if(ptype == 'online')
                {
                    var options = {
                        ...
                        "amount": ttprice*100, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
                        "currency": "INR",
