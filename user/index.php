...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        <?php
                                            ...
                                            {
                                                $c=1;
                                                while(($data = mysqli_fetch_assoc($res)) && $c<=8)
                                                {
                                                    echo '
                                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                                            <div class="rounded position-relative fruite-item">
                                                                <div class="fruite-img" id="scroll1">
                                                                    <img src="../admin/'.$data["image"].'" class="rounded-top" alt="" height="250" width="350">
                                                                </div>
                                                                <div class="text-white btn btn-dark px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">'.$data["category"].'</div>
        ...
        <div class="container-fluid py-5" id="scroll4">
            <div class="container py-5">
                ...
                <div class="row g-4">
                    <?php
                        ...
                        {
                            $c=0;
                            while(($data = mysqli_fetch_assoc($res)) && $c<6)
                            {
                                // if($c % 1 == 0)
                                // {
                                    echo '
                                        <div class="col-lg-6 col-xl-4">
                                            <div class="p-4 rounded bg-light">
                                                <div class="row align-items-center">
                                                    <div class="col-6">
                                                        <img src="../admin/'.$data["image"].'" class="rounded-circle" alt="" width="160" height="180">
                                                    </div>
                                                    <div class="col-6">
                                                        <a href="#" class="h5">Organic '.$data["name"].'</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Fruiteble</a>, All right reserved.</span>
                    </div>
