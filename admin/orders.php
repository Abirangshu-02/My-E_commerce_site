        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4" method="post">
                    <input class="form-control border-0 m-2" type="text" name="uname" placeholder="Search">
                </form>
                <?php
                    if(isset($_POST['uname']))
                    {
                        $rspps = showbyname($_POST['uname']);
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <a href="orders.php" class="btn btn-outline-secondary m-2">All Orders</a>
